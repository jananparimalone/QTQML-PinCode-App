...
namespace {
struct qt_meta_tag_ZN12VideoHandlerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12VideoHandlerE = QtMocHelpers::stringData(
    "VideoHandler",
    "playVideo",
    "",
    "filePath",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12VideoHandlerE[] = {
...
Q_CONSTINIT const QMetaObject VideoHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ZN12VideoHandlerE.offsetsAndSizes,
    qt_meta_data_ZN12VideoHandlerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12VideoHandlerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<VideoHandler, std::true_type>,
        // method 'playVideo'
...
void VideoHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { QMediaPlayer* _r = _t->getPlayer();
...
void *VideoHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12VideoHandlerE.stringdata0))
