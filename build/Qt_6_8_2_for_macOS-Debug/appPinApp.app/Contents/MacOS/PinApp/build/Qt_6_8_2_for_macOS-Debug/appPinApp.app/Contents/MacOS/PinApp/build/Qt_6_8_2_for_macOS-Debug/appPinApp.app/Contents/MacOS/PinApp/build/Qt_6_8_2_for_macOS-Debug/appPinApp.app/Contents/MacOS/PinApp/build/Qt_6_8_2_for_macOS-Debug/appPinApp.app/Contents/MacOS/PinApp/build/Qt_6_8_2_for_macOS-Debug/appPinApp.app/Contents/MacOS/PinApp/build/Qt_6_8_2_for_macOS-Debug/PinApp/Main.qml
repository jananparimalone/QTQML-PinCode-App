...
ApplicationWindow {
    ...
    property string storedPin: ""  // Store the PIN from the file

    // Function to load PIN from FileReader C++ object
    ...
    ColumnLayout {
        ...
        spacing: 20
        visible: pageLoader.source !== ""  // Hide when Welcome.qml is loaded
        ...
        // Define GridLayout for number buttons and "Clear" button
        GridLayout {
            columns: 3
            rowSpacing: 10
            columnSpacing: 10
                    ...
                    onClicked: {
                        if (modelData === "Clear") {
                            ...
                            if (enteredPin === storedPin) {
                                ...
                                pageLoader.source = "Welcome.qml";  // Navigate to Welcome.qml
                            } else {
                                console.log("Incorrect PIN");
                            }
                        } else {
                            pinInput.text += modelData.charAt(0); // Extract digit
                        }
                    }
    ...
    Component.onCompleted: {
        // Load PIN from file upon app start using FileReader
        loadPinFromFile();
    }
}
